...
import {firestore} from '@renderer/core/services/firebaseService';
import type {Ref} from 'vue';
import {ref} from 'vue';
import {IClient} from '@renderer/core/interfaces/clientInterface';
// import {v4 as uuidv4} from 'uuid';
import { IClientInfo, IHost } from '@renderer/core/interfaces/hostInterface';
...
export class ClientPeerRTC extends PeerRTC implements IClient {
  ...
  public setInfo(clientName: string) {
    ...
    if (!this.uuid) this.uuid = crypto.randomUUID(); //uuidv4();
  }
